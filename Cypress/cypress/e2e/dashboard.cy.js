describe('Dashboard Features', () => {
    ...
    beforeEach(()=>{
        ...
        cy.screenshot('dashboard-1-0-1').wait(2000);
    })
    ...
    it('Test that All Posts can be viewed on the dashboard', () => {
        ...
        cy.screenshot('dashboard-1-2-1').wait(2000);
